...
//get mail => user;
  ...
  String Discription =
      "Science City Ahmedabad: Interactive science exhibits, planetarium, and IMAX theater, offering educational experiences in Gujarat, India.";
  String Location = 'Gujrat,Ahmedabad';
  String PlaceName ="Science City";
  int gottenStars =3;
  int selectedindex= -1;
  String ImageData ="img/Science-City.jpg";
  String price = '\u{20B9}500';
