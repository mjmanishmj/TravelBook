...
//get mail => user;
  ...
  String Discription =
      "Kankaria Lake: Recreational hub in Ahmedabad, Gujarat, offering boating, zoo, and gardens for visitors." ;
  String Location = 'Gujrat,Ahmedabad';
  String PlaceName ="kankaria ";
  int gottenStars =2;
  int selectedindex= -1;
  String ImageData ="img/kankaria-lake.jpg";
  String price = '\u{20B9}200';
