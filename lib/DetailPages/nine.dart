...
//get mail => user;
  ...
  String Discription =
      "Akshardham Temple: Majestic Hindu temple in Gujarat, known for its intricate architecture and spiritual ambiance." ;
  String Location = 'Gujrat,Gir Somnath';
  String PlaceName ="Akshardham Temple";
  int gottenStars =4;
  int selectedindex= -1;
  String ImageData ="img/akshardham-temple.jpg";
  String price = '\u{20B9}400';
