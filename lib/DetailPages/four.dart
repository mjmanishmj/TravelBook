...
//get mail => user;
  ...
  String Discription =
      "Somnath Temple: Ancient Hindu temple in Gujarat, revered as one of the twelve Jyotirlinga shrines.";
  String Location = 'Gujrat,Gir Somnath';
  String PlaceName ="Somnath Temple";
  int gottenStars =4;
  int selectedindex= -1;
  String ImageData ="img/Somanath_mandir.jpg";
  String price = '\u{20B9}800';
