...
if(peoples != 0){
  ...
  String Discription =
      "Dwarkadhish Temple in Gujarat, India, venerates Lord Krishna , drawing pilgrims for its spiritual significance and grand architecture.";
 String Location = 'Gujrat,Dwarika';
  String PlaceName ="DwarkaDhish";
  int gottenStars =3;
  int selectedindex= -1;
  String ImageData ="img/Dwarkadhish-Temple-Gujarat.jpg";
String price = '\u{20B9}1200';
