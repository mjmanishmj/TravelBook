...
//get mail => user;
  ...
  String Discription =
      "Marine National Park, located off the coast of Gujarat, India, is a biodiverse sanctuary featuring coral reefs and marine life.";
  String Location = 'Gujrat,Jamnagar';
  String PlaceName ="Marine National Park";
  int gottenStars =3;
  int selectedindex= -1;
  String ImageData ="img/Marine-National-Park.jpg";
  String price = '\u{20B9}900';
