...
//get mail => user;
  ...
  String Discription =
      "Kamla Nehru Zoological Garden in Gujarat: Home to diverse wildlife, including lions and exotic species, for conservation and education.";
  String Location = 'Gujrat,Ahmedabad';
  String PlaceName ="Kamla Nehru Zoo";
  int gottenStars =2;
  int selectedindex= -1;
  String ImageData ="img/kamla-zoo.jpg";
  String price = '\u{20B9}150';
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            AppText(text: '(3.0)',color: Colors.deepPurple[300]!.withOpacity(0.9),)
                          ],
                        ),
                        const SizedBox(
                          height: 1,
