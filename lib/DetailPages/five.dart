...
//get mail => user;
  ...
  String Discription =
      "Rani-ki-Vav: UNESCO World Heritage Stepwell in Gujarat, intricately carved with sculptures and architecture."  ;
  String Location = 'Gujrat';
  String PlaceName ="Rani Ki Vav";
  int gottenStars =2;
  int selectedindex= -1;
  String ImageData ="img/rani-ki-va.webp";
  String price = '\u{20B9}300';
